            ...
            <div class="row  mb-4 d-flex align-items-center justify-content-center">
                <div class="col-5 ">
                    <div class="w-100 justify-content-center align-items-center">
                        ...
                        <img id="previewImagem" src="/Spectrum/person.svg" class="p-1 border rounded-circle border-dark" style="min-width: 80px; min-height: 80px; max-width: 80px; max-height: 80px;">
                        </label>
                    </div>
                </div>
                <div class="col-7 ">
